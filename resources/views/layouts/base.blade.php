...
<body class="home-page home-01 ">
									...
									@auth
										...
										<li class="menu-item menu-item-has-children parent" >
											...
											<ul class="submenu curency" >
												...
												<li class="menu-item">
													<a href="{{route('admin.categories')}}" title="Category">Categories</a>
												</li>
												<li class="menu-item">
												...
												<li class="menu-item">
													<a href="{{route('admin.sale')}}" title="Manage Sale Setting">Manage Sale Setting</a>
												</li>
												<li class="menu-item">
													<a href="{{route('admin.coupons')}}" title="Manage Sale Setting">Manage Coupons</a>
												</li>
												<li class="menu-item">
													<a href="{{route('admin.orders')}}" title="Manage Sale Setting">Orders</a>
												</li>
												<li class="menu-item">
					...
					<div class="mid-section main-info-area">
						...
						@livewire('cart-count-component')	
							<div class="wrap-icon-section show-up-after-1024">
								<a href="{{route('product.cart')}}" class="mobile-navigation">
									<span></span>
									<span></span>
									<span></span>
								</a>
	...
	<script src="https://cdn.tiny.cloud/1/elnjmhwn6blkcfo088ya8dt8v32auaiwepatv6y7mfe8as4u/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts
	@stack('scripts')
</body>
</html>