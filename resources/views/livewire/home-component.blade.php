					...
					<div class="product product-style-2 equal-elem ">
						<div class="product-thumnail">
							<a href="{{route('product.details',['slug'=>$s_product->slug])}}" title="{{$s_product->name}}">
								<figure><img src="{{asset('assets/images/products/'.$s_product->image)}}" width="800" height="800" alt="{{$s_product->name}}"></figure>
							</a>
						...
						<div class="product-info">
							...
							<div class="wrap-price">
								<ins><p class="product-price">${{$s_product->sale_price}}</p></ins>
								<del><p class="product-price regprice">${{$s_product->regular_price}}</p></del>	
							</div>
						</div>
					</div>
				@endforeach
								...
								@foreach($c_products as $c_product)
									...
									<div class="product product-style-2 equal-elem ">
										<div class="product-thumnail">
											...
											<div class="wrap-btn">
												<a href="{{route('product.details',['slug'=>$c_product->slug])}}" title="{{$c_product->name}}" class="function-link">quick view</a>
											</div>
										</div>
										<div class="product-info">
