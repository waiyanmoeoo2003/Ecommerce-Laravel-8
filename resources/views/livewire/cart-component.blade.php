			...
			@if(Cart::instance('cart')->count() > 0)
				...
				<div class="summary">
					<div class="order-summary">
						...
						@if(Session::has('coupons'))
							<p class="summary-info"><span class="title">Discount ({{Session::get('coupons')['code']}}) <a href="" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i></a></span><b class="index">-${{number_format($discount)}}</b></p>
							<p class="summary-info"><span class="title">Subtotal with discount ({{Session::get('coupons')['code']}})</span><b class="index">${{number_format($subtotalAfterDiscount)}}</b></p>
							<p class="summary-info"><span class="title">Tax ({{number_format(config('cart.tax'))}}%)</span><b class="index">${{number_format($taxAfterDiscount)}}</b></p>
				...
				@else
					<div class="text-center" style="padding:30px 0;">
						...
						<p>Add iten to it now</p>
						<a href="/shop" class="btn btn-success">Shop Now</a>
					</div>
				@endif
				<div class="wrap-iten-in-cart">
				<h3 class="title-box" style="border-bottom:1px solid; padding-bottom:15px">{{Cart::instance('saveforlater')->count()}} items Saved For Later</h3>
